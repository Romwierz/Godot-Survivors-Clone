...
# co 4s z tablicy target_array usuwany i dodawany jest nowy cel, w kierunku którego
# podąża javelin
...
# co 3s pozycja do jakiej zmierza javelin to okolice pozycji gracza +- 50 pikseli losowej współrzędnej
